<?php /* Smarty version 2.6.26, created on 2017-03-01 10:00:35
         compiled from mybook.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'mybook.tpl', 18, false),)), $this); ?>
...
<div class="container">
        <div class="col-md-12 column"><!---->
            <div class="row clearfix">
                <?php $_from = $this->_tpl_vars['mybook']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['v']):
?>
                <div class="col-md-4 column" style="padding-bottom: 10px;padding-top: 10px; ">
                    <div class="content-img-div">
                        <img src="<?php echo $this->_tpl_vars['v']->cover; ?>
" class="content-img1" style="width: 80px; height: 130px; margin-right: 5px;">
                    </div>
