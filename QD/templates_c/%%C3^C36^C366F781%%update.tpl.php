<?php /* Smarty version 2.6.26, created on 2017-02-24 14:55:54
...
<!-- start 中间部分 -->
    ...
    <div class="container">
        <div class="row clearfix">
            <div class="col-md-12 column">
                <from action="admin.php?c=backplan&m=personal">
                <ul class="list-unstyled">
                    ...
                    <br/>
                    <li>
                        <input type="password" name="" placeholder="新的密码">
                    </li>
                    <br/>
                    <li>
                    ...
                    <br/>
                    <li>
                        <input type="submit" name="" value="修改密码" style="background-color: #09B396">
                    </li>
                </from>
                </ul>
            </div>
