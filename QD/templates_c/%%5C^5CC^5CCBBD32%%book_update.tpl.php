<?php /* Smarty version 2.6.26, created on 2017-02-28 18:00:48
         compiled from book_update.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<center>
    ...
    <form  name="content" style="text-align: left; width: 400px; margin-left: 10%"action="" method="post">
        <p>
            <span>图书名称：</span>
            <input type="text" value="<?php echo $this->_tpl_vars['book']->book_name; ?>
" placeholder="图书名称不超过20中文字符" name="book_name">
        </p>
        <p>
            <span>图书封面：</span>
            <input type="text" name="cover" class="text" value="<?php echo $this->_tpl_vars['book']->cover; ?>
" />
...
" ><?php echo $this->_tpl_vars['val']->book_nav; ?>
        ...
        <p class="ckeditor">
            图书简介：
                    <span>
                        <textarea id="TextArea1" name="book_info" class="ckeditor"><?php echo $this->_tpl_vars['book']->book_info; ?>
 </textarea>
                    </span>
        </p>
        <p>
