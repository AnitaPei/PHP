        ...
        <div class="col-md-12 column"><!---->
            <div class="row clearfix">
                ...
                <div class="col-md-4 column" style="padding-bottom: 10px;padding-top: 10px; ">
                    ...
                    <a href="read.php?bookid={{$v->id}}"> <p class="content-h">{{$v->book_name}}</p></a>
                    <a href="">
                    ...
                    <span  class="content-span content-nav-a">{{$v->book_nav}}| </span>  <span  class="content-span">{{$v->update_mode}}</span>
